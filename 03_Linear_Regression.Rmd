...
3E1: 
the hypothesis testing of the coef. null hypothesis, beta = 0, alternative, beta != 0. 
...
3E3
Application of multiple linear regression and interpretation of the coef, inc interaction. 

Note: the effect of coef is not related to the size of the number, use t test and it depends on the value. 

3E4

Model flexibility, training errors and testing errors. 
...
In the case of simple linear regression, least square line always pass through the mean point. 

3E7

The R square statistic is equal to the square of the correlation between X and Y. Lot's of algebra to proof. 
